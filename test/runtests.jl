...
facts("check NV test") do
  ...
  @fact ratio1[11,:].array --> [3.20493,1.65464,1.58198,2.29313,2.62537,1.60292,2.833,1.53379,1.3137,1.466]
  @fact ratio2[11,:].array --> [3.11605,1.66144,1.58688,2.29877,2.59052,1.60218,2.78695,1.51405,1.31453,1.434]
  test_nv_gui("-1", Int32(0))
  @fact ratio1[1,:].array --> [3.54587,1.50695,1.46578,2.02017,2.65911,1.49107,2.92208,1.68278,1.26246,1.75563]
  @fact ratio2[1,:].array --> [3.45319,1.49744,1.45775,1.99627,2.6173,1.4776,2.86991,1.67206,1.25719,1.73787]
